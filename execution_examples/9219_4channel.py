...
def main():
	...
	column_list=['Time (s)','Resistance_1','Resistance_2','Resistance_3','Resistance_4','Time for last cycle']
	big_data=np.empty((0,len(column_list)))
	delta_loop = 0

	print('\n Starting up')
	c = cDAQ_api.cDAQ()
	list_o_channels = ['cDAQ2Mod2/ai0','cDAQ2Mod2/ai1','cDAQ2Mod2/ai2','cDAQ2Mod2/ai3']
	...
	try:
		while(True): 
			...
			#
			new_row = np.array([[current_time,buff[0,-1],buff[1,-1],buff[2,-1],buff[3,-1],delta_loop]])
